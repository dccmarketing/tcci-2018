					...
					<ul>
						<li class="copyright">
							&copy <?php echo date( 'Y' ); ?> <a href="<?php echo esc_url( get_admin_url() ); ?>"><?php echo get_bloginfo( 'name' ); ?></a>
                                                ...
                                                <li>
                                                        <a href="mailto:sales@tccimfg.com">sales@tccimfg.com</a> 
						<li>
						...
						<li class="credits"><?php
							...
							printf( esc_html__( 'Site created by %1$s', 'tcci' ), '<a href="https://www.dccmarketing.com/" rel="nofollow" target="_blank">DCC</a>' );
