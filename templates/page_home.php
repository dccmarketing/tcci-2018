...
?><div id="primary" class="content-area full-width">
	<main id="main" role="main">
		...
		?>		<section class="home-products clear">
			...
			?></div>
		</section><section class="home-pillars clear"><?php
				...
				?><ul class="home-pillars-list"><?php
					...
					foreach ( $fields['pillars'] as $pillar ) :
						...
						?><li class="home-pillar">
							<a href="/about-us/"><img class="home-pillar-icon" src="<?php echo esc_url( $pillar['pillar_icon'] ); ?>" /></a>
						</li><?php
		...
		<section class="home-innovation clear">
			<div class="home-innovation-wrap"><?php
				...
				if ( ! empty( $fields['innovation_content'] ) ) {
					...
					?></div><div style="display:block; margin: 0 auto; width: 70%;"><?php
				...
				if ( ! empty( $fields['innovation_product'] ) && is_object( $fields['innovation_product'] ) ) :
					...
					<div class="home-innovation-content"><div style="display: block; margin-top: auto; margin-bottom: auto; height: 50%;">
							<a href="https://tccimfg.com/product/qp25/?utm_source=website&utm_medium=click&utm_campaign=innovationqp25spotlight"><img src="<?php echo esc_url( $images['sizes']['medium']['url'] ); ?>" /></a></div>
