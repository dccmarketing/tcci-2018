...
class TCCI_Slushicons {
	...
	public function hooks() {
		...
		add_filter( 'tcci2018_menu_item_icon_name', 	array( $this, 'get_icon_info' ), 10, 3 );
		add_filter( 'tcci2018_menu_item_text_position', array( $this, 'get_text_position' ), 10, 3 );
	...
	public function add_icons_to_menu( $title, $item, $args, $depth ) {
		...
		$textpos 	= apply_filters( 'tcci2018_menu_item_text_position', '', $item, $args );
		$icon_name 	= apply_filters( 'tcci2018_menu_item_icon_name', '', $item, $args );
	 ...
	 * @hooked 		tcci2018_menu_item_icon_name 		10
	 ...
	 *
	 * @exits 		If $classes is empty.
	 * @hooked 		tcci2018_menu_item_text_position 		10
	...
	private function check_for_svg_file( $file ) {
		...
		/**
		 * The tcci2018_svg_paths filter.
		 */
		$paths = apply_filters( 'tcci2018_svg_paths', $paths );
